...
#ifndef IGNITION_GUI_PLUGINS_TOPICSPY_HH_
#define IGNITION_GUI_PLUGINS_TOPICSPY_HH_
...
namespace plugins
{
  ...
  /// \brief Discover all Ignition Transport topics and introspect their type
  /// and value.
  class TopicSpy : public Plugin
  {
    Q_OBJECT
    ...
    private: std::unique_ptr<TopicSpyPrivate> dataPtr;
  };
}
}
}
