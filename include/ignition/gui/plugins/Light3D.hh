...
#ifndef IGNITION_GUI_PLUGINS_LIGHT3D_HH_
#define IGNITION_GUI_PLUGINS_LIGHT3D_HH_
...
namespace plugins
{
  ...
  /// * <pose> : Light pose, defaults to the origin.
  /// * <color> : Light color, defaults to (0.7, 0.7, 0.7, 1.0)
  class Light3D : public Object3DPlugin
  {
    Q_OBJECT
    ...
    private: std::unique_ptr<Light3DPrivate> dataPtr;
  };
}
}
}
