 ...
 *
*/
#ifndef IGNITION_GUI_PLUGINS_PLOT_CANVAS_HH_
#define IGNITION_GUI_PLUGINS_PLOT_CANVAS_HH_
...
namespace plot
{
  ...
  class Canvas : public QWidget
  {
    ...
    public: explicit Canvas(QWidget *_parent);
    ...
    public: CurveWeakPtr PlotCurve(const unsigned int _variableId);
    ...
    private: std::unique_ptr<CanvasPrivate> dataPtr;
  };
}
}
}
