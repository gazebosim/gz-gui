...
//      maximumValue: 10000.0
    ...
    Switch {
      ...
      onToggled: {
        ...
        module.msgType = msgTypeField.text
        module.topic = topicField.text
        module.msgData = msgDataField.text
        module.frequency = frequencyField.value

        module.OnPublish(checked);
      }
