...
/////////////////////////////////////////////////
TEST(MinimalSceneTest, Load)
{
  setVerbosity(4);
  EXPECT_TRUE(initApp());

  EXPECT_TRUE(loadPlugin("MinimalScene"));

  EXPECT_TRUE(stop());
}

/////////////////////////////////////////////////
TEST(MinimalSceneTest, Resize)
{
  setVerbosity(4);
  EXPECT_TRUE(initApp());
...
TEST(MinimalSceneTest, Config)
{
  ...
  EXPECT_TRUE(ignition::gui::loadPlugin("MinimalScene",
