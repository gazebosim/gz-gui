...
// empty plot id
const unsigned int Canvas::EmptyPlot = ignition::math::MAX_UI32;

// global plot id count
unsigned int CanvasPrivate::globalPlotId = 0;
...
/////////////////////////////////////////////////
unsigned int Canvas::AddVariable(const std::string &_variable,
...
/////////////////////////////////////////////////
void Canvas::AddVariable(const unsigned int _id,
    const std::string &_variable, const unsigned int _plotId)
{
  ...
  Data *p = it->second;
  CurveWeakPtr curve = p->plot->AddCurve(_variable);
  auto c = curve.lock();
  if (c)
  {
...
/////////////////////////////////////////////////
void Canvas::RemoveVariable(const unsigned int _id,
    const unsigned int _plotId)
{
  ...
  CurveWeakPtr plotCurve = it->second->plot->Curve(curveId);
...
/////////////////////////////////////////////////
unsigned int Canvas::PlotByVariable(const unsigned int _variableId) const
{
...
/////////////////////////////////////////////////
void Canvas::OnAddVariable(const std::string &_variable)
{
...
/////////////////////////////////////////////////
void Canvas::OnAddVariable(const unsigned int _id,
...
/////////////////////////////////////////////////
void Canvas::OnRemoveVariable(const unsigned int _id,
...
/////////////////////////////////////////////////
void Canvas::OnMoveVariable(const unsigned int _id,
    const unsigned int _targetId)
{
...
/////////////////////////////////////////////////
void Canvas::OnSetVariableLabel(const unsigned int _id,
  ...
  for (const auto &it : this->dataPtr->plotData)
  {
    for (const auto &v : it.second->variableCurves)
    {
      ...
      VariablePill *variablePill =
          this->dataPtr->yVariableContainer->VariablePill(variableId);

      if (!variablePill)
        continue;

      CurveWeakPtr curve = it.second->plot->Curve(curveId);
      auto c = curve.lock();
      if (!c)
        continue;
...
/////////////////////////////////////////////////
bool Canvas::eventFilter(QObject *_o, QEvent *_e)
{
...
/////////////////////////////////////////////////
unsigned int Canvas::PlotCount() const
{
...
/////////////////////////////////////////////////
unsigned int Canvas::VariableCount(const unsigned int _plotId) const
{
  auto it = this->dataPtr->plotData.find(_plotId);
  if (it == this->dataPtr->plotData.end())
    return 0u;
...
/////////////////////////////////////////////////
CurveWeakPtr Canvas::PlotCurve(const unsigned int _variableId)
{
  for (const auto it : this->dataPtr->plotData)
  {
    const auto v = it.second->variableCurves.find(_variableId);
...
/////////////////////////////////////////////////
std::vector<IncrementalPlot *> Canvas::Plots() const
{
...
/////////////////////////////////////////////////
std::string Canvas::UniqueFilePath(const std::string &_pathAndName,
...
/////////////////////////////////////////////////
void Canvas::SetDeleteCanvasEnabled(const bool _enable)
{
...
/////////////////////////////////////////////////
void Canvas::Export(const std::string &_dirName,
...
/////////////////////////////////////////////////
void Canvas::ExportPDF(const std::string &_filePrefix) const
{
...
/////////////////////////////////////////////////
void Canvas::ExportCSV(const std::string &_filePrefix) const
{
